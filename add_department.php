...
<div class="main-content container-fluid">
    ...
    <div class="row match-height">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-vertical" action="SaveDepartment.php" method="post">
                <div class="form-body">
                    <div class="row">
                    <div class="col-12">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control" placeholder="Input Department" name="dpsname" id="dpsname">
                    ...
                    <div class="col-12">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="text" class="form-control" placeholder="Input Department Name" name="dpname" id="dpname">
                                <div class="form-control-icon">
                                    <i class="fa fa-table"></i>
                                </div>
                            </div>
