...
<div class="sidebar-header" style="height: 50px;margin-top: -30px">
        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                ...
                <?php
                              $department_array = $db_handle->runQuery("SELECT * FROM department ORDER BY id ASC");
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table class='table' id="table1">
                                ...
                                <tbody>
                                    <tr>
                                        <td><?php echo $department_array[$key]["department_name"];?></td>
                                        <td><?php echo $department_array[$key]["department_shortname"];?></td>
                                        <td><?php echo $department_array[$key]["create_date"];?></td>
