        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                ...
                <section class="section">
                        <?php
                              $employee_array = $db_handle->runQuery("SELECT * FROM employees ORDER BY emp_id ASC");
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table class='table' id="table1">
                                ...
                                <tbody>
                                    <tr>
                                        <td><?php echo $employee_array[$key]["emp_id"];?></td>
                                        <td><?php echo $employee_array[$key]["firstname"];?></td>
                                        <td><?php echo $employee_array[$key]["department"];?></td>
                                        <td>
                                            <span class="badge bg-success">Active</span>
                                        </td>
                                        <td><?php echo $employee_array[$key]["regdate"];?></td>
                                        <td><a href="editstaff.php"><i class="fa fa-pen text-success"></i></a>   <a href="editDesignation.php"><i class="fa fa-trash text-danger"></i></a></td>
                                    </tr>
