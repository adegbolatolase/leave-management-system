...
<div class="sidebar-header" style="height: 50px;margin-top: -30px">
        ...
        <div id="main">
            ...
            <div class="main-content container-fluid">
                ...
                <?php
                              $leaves_array = $db_handle->runQuery("SELECT * FROM leaves_type ORDER BY id ASC");
                              if (!empty($leaves_array)) { 
                                 foreach($leaves_array as $key=>$value){
                ?>
                    <div class="card">
                        <div class="card-body">
                            <table class='table' id="table1">
                                ...
                                <tbody>
                                    <tr>
                                        <td><?php echo $leaves_array[$key]["leave_name"];?></td>
                                        <td><?php echo $leaves_array[$key]["description"];?></td>
                                        <td><?php echo $leaves_array[$key]["days_allowed"];?></td>
